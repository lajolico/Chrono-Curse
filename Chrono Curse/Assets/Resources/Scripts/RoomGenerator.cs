...
public class RoomGenerator : MapGenerator
{
    ...
    {
        var roomsList = ProcedureAlgorithm.BSP(new BoundsInt((Vector3Int)startPos, new Vector3Int(    
        ...
        WallLogic.CreateWalls(floor, tilemapVisualizer);
    }
    ...
    private HashSet<Vector2Int> ConnectRooms(List<Vector2Int> roomCenters)
    {
        ...
        while(roomCenters.Count > 0)
        {
            ...
            HashSet<Vector2Int> newCorridor = CreateCorridor(currentRoomCenter, closest,corridorWidth );
    ...
    */
    ...
    private HashSet<Vector2Int> CreateCorridor(Vector2Int currentRoomCenter, Vector2Int destination, int corridorWidth)
    {
    ...
    */
    private HashSet<Vector2Int> SetRooms(List<BoundsInt> roomsList)
    {
        ...
        for (int i = 0; i < roomsList.Count; i++)
        {
            ...
            var roomFloor = GetFloorPositions(dungeonParams, roomCenter);
